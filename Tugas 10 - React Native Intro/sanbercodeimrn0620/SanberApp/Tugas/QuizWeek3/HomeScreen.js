        ...
        <View style={{ minHeight: 50, width: DEVICE.width * 0.88 + 20, marginVertical: 8 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            {/* //? #Soal 1 Tambahan, Simpan userName yang dikirim dari halaman Login pada komponen Text di bawah ini */}
              <Text style={styles.headerText}>Username {/*{this.props.route.params.userName}*/}</Text>
            </Text>
...
const styles = StyleSheet.create({
  ...
  itemButton: {
    ...
    justifyContent: 'center',
    alignSelf: 'flex-end',
    borderRadius: DEVICE.width * 0.03,
    width: DEVICE.width * 0.35,
    height: DEVICE.width * 0.09
  },
