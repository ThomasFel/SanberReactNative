    ...
    return (
      <SafeAreaView style={styles.droidSafeArea}>
        <View style={styles.container}>
          <Image source={require('./images/logo.png')} style={{width: 375, height: 102, marginTop: 63}} />
          ...
          <TouchableOpacity style={styles.registerBox} onPress={() => this.props.navigation.navigate('Login')}>
          ...
          <TouchableOpacity style={styles.loginBox} onPress={() => this.props.navigation.navigate('Login')}>
